        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Selamat Datang di kabupaten</h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                                                ...
                                                @foreach ($kabupaten as $data)
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <form action="{{ route('kabupaten.destroy', $data->id) }}" method="POST">
                                                            ...
                                                            @method('DELETE')
                                                            <td class="center">
                                                                <a href="{{ route('kabupaten.edit', $data->id) }}" class="btn btn-success">Ubah</a>
                                                                <a href="{{ route('kabupaten.show', $data->id) }}" class="btn btn-warning">Detail</a>
